...
def main():
    ...
    parser.add_argument('--dataroot', type=str, default='./TsinghuaDog/')
    ...
    train_loader = TsinghuaDog(root_dir, batch_size=batch_size, train=True, part='train', shuffle=True, transform=transform_train)
    ...
    val_loader = TsinghuaDog(root_dir, batch_size=batch_size, train=False, part='val', shuffle=False, transform=transform_test)
    epochs = args.epochs
    # model = Net(classes=args.num_classes)
    model = Net()
    lr = args.lr
    # 优化空间，改Adam或lrf
